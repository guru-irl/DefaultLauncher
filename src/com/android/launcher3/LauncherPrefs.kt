...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        // Key is "pref_folder_icon_color" for backward compat; stores cover background color
        @JvmField val FOLDER_ICON_COLOR = backedUpItem("pref_folder_icon_color", "")
        ...
        @JvmField val SEARCH_CONTACTS = backedUpItem("pref_search_contacts", false)
        @JvmField val SEARCH_CALENDAR = backedUpItem("pref_search_calendar", false)
