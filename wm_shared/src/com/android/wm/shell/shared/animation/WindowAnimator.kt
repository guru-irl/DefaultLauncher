...
object WindowAnimator {
     ...
     * @param change the change to which the animation should be applied (TransitionInfo.Change)
    ...
    fun createBoundsAnimator(
        ...
        val endAbsBounds = HiddenApiCompat.getEndAbsBounds(change) ?: Rect()
        val startPos =
            getPosition(
                displayMetrics,
                endAbsBounds,
        ...
        val leash = HiddenApiCompat.getLeash(change)
        val endPos =
            getPosition(
                displayMetrics,
                endAbsBounds,
        ...
        return ValueAnimator.ofObject(PointFEvaluator(), startPos, endPos).apply {
            ...
            addUpdateListener { animation ->
                ...
                HiddenApiCompat.setFrameTimelineVsyncId(transaction)
                transaction.apply()
            }
        }
    }
